  ...
  return (
    <div id="home">
      ...
      <div className="flex gap-6 justify-center">
        <div className="text-white p-3 w-40 h-12 rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:border-2 border-white cursor: pointer transition-transform duration-500 hover:scale-125"><a href="#contact">
          Connect with me
          </a>
        </div>
